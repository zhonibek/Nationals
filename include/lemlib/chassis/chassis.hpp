...
/**
 * @brief Enum class DrivebaseType
 * Distinguishes between Differential (Tank) and Holonomic (X-Drive, Mecanum) drivetrains.
 */
enum class DrivebaseType {
    TANK,       /**< Standard Differential Tank Drivetrain */
    XDRIVE,     /**< 4-wheel Holonomic X-Drive Drivetrain (45-degree omni wheels) */
    MECANUM     /**< 4-wheel Holonomic Mecanum Drivetrain */
};
...
class Chassis {
    public:
        ...
        /**
         * @brief Chassis constructor with explicit LQR settings
         *
         * @param drivetrain drivetrain to be used for the chassis
         * @param linearSettings settings for the lateral PID controller
         * @param angularSettings settings for the angular PID controller
         * @param lateralLQRSettings settings for the lateral LQR controller
         * @param angularLQRSettings settings for the angular LQR controller
         * @param sensors sensors to be used for odometry
         * @param throttleCurve curve applied to throttle input during driver control
        ...
        /**
         * @brief Set the drivetrain base type (TANK, XDRIVE, MECANUM)
         */
        void setDrivebaseType(DrivebaseType type);
        /**
         * @brief Get the active drivetrain base type
         */
        DrivebaseType getDrivebaseType() const;
        /**
        ...
        /**
         * @brief Set the active motion controller type (PID or LQR)
         *
         * @param type MotionControllerType::PID or MotionControllerType::LQR
         */
        void setMotionControllerType(MotionControllerType type);

        /**
         * @brief Get the active motion controller type
         *
         * @return MotionControllerType
         */
        MotionControllerType getMotionControllerType() const;

        /**
         * @brief Switch to unified Hybrid LQR + PID motion controller mode
         */
        void useHybrid();

        /**
         * @brief Switch to LQR motion controller mode
         *
         * @param enable true to use LQR, false for PID
         */
        void useLQR(bool enable = true);

        /**
         * @brief Switch to PID motion controller mode
         */
        void usePID();

        /**
         * @brief Set lateral LQR settings
         *
         * @param settings new LQR settings
         */
        void setLateralLQR(LQRSettings settings);

        /**
         * @brief Set angular LQR settings
         *
         * @param settings new LQR settings
         */
        void setAngularLQR(LQRSettings settings);

        /**
         * @brief Get reference to lateral LQR controller
         */
        LQR& getLateralLQR();

        /**
         * @brief Get reference to angular LQR controller
         */
        LQR& getAngularLQR();
    ...
    protected:
        ...
        LQRSettings lateralLQRSettings;
        LQRSettings angularLQRSettings;
