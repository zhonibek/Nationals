...
lemlib::ControllerSettings linearController(
    10.0f, // kP: increase if stops short, decrease if oscillates
...
lemlib::LQRSettings lateralLQR(
    10.0f, // kP: position error gain
...
lemlib::LQRSettings angularLQR(
    1.0f,  // kP: angular position gain
